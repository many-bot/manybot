...
export interface IContact {
  /**
   * The contact's primary identifier. For users, this is always the `@lid`
   * JID when known, or `null` if the LID could not be resolved. For groups,
   * this is the `@g.us` JID.
   */
  id: string | null;
  /**
