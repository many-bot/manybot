 ...
 *
 * Usage in plugin:
 *   import { createPluginI18n } from "../utils/pluginI18n.ts";
 ...
 */
function loadTranslations(localeDir: string, lang: string): { translations: Record<string, unknown>; fallback: Record<string, unknown> } {
 ...
 */
export function createPluginI18n(pluginMetaUrl: string) {
   ...
   * @returns {string}
   */
  function t(key: string, context: Record<string, unknown> = {}): string {
