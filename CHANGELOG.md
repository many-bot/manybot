...
- **README refresh** — Replaced the minimal package overview with current setup, configuration, plugin, command, runtime utility, testing, troubleshooting and contribution guidance.
- **Contributor guide refresh** — Replaced outdated Sonic-era tooling and layout guidance with the current TypeScript workflow, architecture boundaries, plugin API rules, test gates, security practices, Git workflow, and release process.
